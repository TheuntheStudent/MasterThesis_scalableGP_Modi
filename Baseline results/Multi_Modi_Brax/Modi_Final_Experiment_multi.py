...
def run_environment(env, num_outputs, seed = 0, layer_sizes = 2, backend = 'generalized', pop_size = 100, num_pop = 5, num_gen = 50, batch_size = 16, max_nodes=31):
...
if __name__ == '__main__':
    ...
    envs_list = ['reacher', 'swimmer', 'walker2d', 'halfcheetah', 'ant']
    output_sizes = [1, 1, 3, 3, 4]
    num_trees = 2
    seeds = [0, 26, 10]
