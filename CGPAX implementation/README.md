...
Simple implementations of Cartesian Genetic Programming (CGP) and Linear Genetic Programming (LGP) in JAX, taken from https://github.com/giorgia-nadizar/cgpax.
